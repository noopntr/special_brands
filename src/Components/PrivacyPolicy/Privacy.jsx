      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">
            ...
            <p>
                This privacy policy sets out how this website  uses and protects any information that you give  while using this website. The website is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement. The website  may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes.
                    WHAT WE COLLECT
                    ...
                    You may request details of personal information which we  hold about you Database protection. If you would like a copy of the information held on you please email us this request using our Contact Us information.
